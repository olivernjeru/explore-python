...
class TicTacToe:
    ...
    def print_board_nums():
        ...
        number_board = [[str(i) for i in range(j*3, (j+1)*3)]
                        for j in range(3)]  # creating the 3*3 number board
    ...
    def winner(self, square, letter):
        ...
        # check diagonals only is the square is an even number (0, 2, 4, 6, 8), the only possible moves to win diagonally
        if square % 2 == 0:
    ...
    def play(game, x_player, o_player, print_game=True):
        ...
        # we dont have to worry about the winner because we'll return that which breaks the loop
